...
function createTanStackMcpHandler(mcp, options = {}) {
	...
	return ({ request }) => handler(forwarded(request, options), require_cors.createRecorderForRuntime(mcp, { stack: STACK }));
}
/**
...
function createTanStackInvokeToolHandler(mcp, options = {}) {
	...
	return ({ request, params }) => handler(forwarded(request, options), params.tool, require_cors.createRecorderForRuntime(mcp, { stack: STACK }));
}
/**
...
exports.createTanStackListToolsHandler = createTanStackListToolsHandler;
exports.createTanStackMcpHandler = createTanStackMcpHandler;
exports.createTanStackOAuthProtectedResourceMetadataHandler = createTanStackOAuthProtectedResourceMetadataHandler;
